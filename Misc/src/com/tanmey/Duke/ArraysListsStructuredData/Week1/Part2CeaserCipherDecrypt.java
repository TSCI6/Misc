...
public class Part2CeaserCipherDecrypt {
    ...
    public String decrypt(String encrypted) {
        Part1CaeserCipher cc = new Part1CaeserCipher();
    ...
    public void testDecryptTwoKeys() {
		 ...
		 * 
		 * message =
		 * "Io iwjv jz dv bcm kjvammmikz mwju edbc twpz pvb wi awm v ncmxmqnm xvzog. TMZMZMZMZMZMZMGT TJCY!"
		 * ; System.out.println("Decrypted message = " + decryptTwoKeys(message));
		 * 
    ...
    public static void main (String args[])
	{
		...
		Part2CeaserCipherDecrypt obj = new Part2CeaserCipherDecrypt();
