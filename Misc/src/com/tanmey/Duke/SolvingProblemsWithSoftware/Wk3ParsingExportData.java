...
public class Wk3ParsingExportData
{
    ...
    public void tester()
    {
		...
		/*
		 * parser = fr.getCSVParser();
		 * System.out.println("Total countries that export cocoa: "+
		 * numberOfExporters(parser, "cocoa"));
		 */
		 
		
		  parser = fr.getCSVParser(); System.out.println("Big Exporters: ");
    ...
    {
        Wk3ParsingExportData CSV = new Wk3ParsingExportData();
        CSV.tester();
    }
}